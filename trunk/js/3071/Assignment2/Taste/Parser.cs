...
/*--------------------------------------------------------------------------*/
	...
	void ConstDecl() {
		...
		if (la.kind == 2) {
			...
			Console.WriteLine("Constant : " + obj.type);  
		} else if (la.kind == 8) {
			Get();
			gen.Emit(Op.CONST, 0); type = boolean;
			if (obj.level == 0) gen.Emit(Op.STOG, obj.adr);
	...
	static readonly bool[,] set = {
		...
		{x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,T,T,T, T,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x},
		{x,T,x,x, x,x,x,x, x,x,x,x, x,x,T,x, x,x,x,x, x,x,x,x, x,x,T,x, x,x,T,x, T,T,T,T, T,x,T,T, x,T,x,x},
		{x,T,x,x, x,x,x,x, x,x,x,x, x,x,T,x, x,x,x,x, x,x,x,x, x,x,T,x, x,x,T,x, T,T,T,T, T,x,x,x, x,x,x,x},
		{x,T,T,x, T,x,x,T, T,x,x,x, x,T,T,T, x,x,x,x, x,x,x,T, x,x,T,T, T,T,T,T, T,T,T,T, T,x,T,T, x,T,x,x},
		{x,x,x,x, x,x,x,x, x,x,x,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,T, x,T,x,x}
...
public class Errors {
	...
	public virtual void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 51: s = "invalid ConstDecl"; break;
